...
<head>
    ...
    <meta name="description"
          content="HRMS Leave Report">

    <meta name="keywords"
          content="HRMS, Human Resource Management System, Leave Report">
...
<script>
    ...
    if (typeof ApexCharts !== 'undefined') {
        ...
        new ApexCharts(document.querySelector("#leave-chart"), {
            chart: {
                type: 'bar',
                height: 280
            },
            series: [
                { name: 'Leave Requests', data: leaveTypeCounts }
            ],
            xaxis: {
