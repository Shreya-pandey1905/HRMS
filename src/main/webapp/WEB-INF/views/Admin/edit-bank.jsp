...
<head>
    ...
    <title>Edit Bank Details | HRMS</title>
        ...
        <div class="content">
            ...
            <div class="page-header">
                ...
                <div class="page-title">
                    ...
                    <h6>Update employee bank information</h6>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="${pageContext.request.contextPath}/employee/bank/edit"
                          method="post">

                        <input type="hidden"
                               name="bankDetailId"
                               value="${bankDetails.bankDetailId}">
