...
<head>
    ...
    <style>
        .sidebar{height:100vh!important;overflow-y:auto!important}.event-card{border:1px solid #e9ecef;border-radius:10px}.event-table th{background:#eef0f3;white-space:nowrap}.add-btn{background:#ff6b35;border-color:#ff6b35;color:#fff}.add-btn:hover{background:#e85b29;border-color:#e85b29;color:#fff}.status-active{background:#16c784;color:#fff}.status-inactive{background:#e53935;color:#fff}.status-pill{display:inline-flex;align-items:center;gap:6px;padding:5px 10px;border-radius:5px;font-size:12px;font-weight:600}.type-dot{width:12px;height:12px;border-radius:3px;display:inline-block;margin-right:6px}.action-btn{border:0;background:transparent;color:#52677d;font-size:18px;margin-right:8px}
    </style>
</head>
