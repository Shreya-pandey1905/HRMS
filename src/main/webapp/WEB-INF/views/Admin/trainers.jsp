...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <%
                String trainerDeleteError =
                        (String) session.getAttribute("trainerDeleteError");

                if (trainerDeleteError != null) {
                    session.removeAttribute("trainerDeleteError");
            %>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <textarea name="description"
                                                              class="form-control"
                                                              rows="4"
                                                              required><%= trainer.getDescription() == null ? "" : trainer.getDescription() %></textarea>
