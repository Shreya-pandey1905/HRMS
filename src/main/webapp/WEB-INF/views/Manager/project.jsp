                   ...
                   <nav>
                      <ol class="breadcrumb mb-0">
                         <li class="breadcrumb-item">
                            <a href="${pageContext.request.contextPath}/ManagerDashboardServlet?action=dashboard"><i class="ti ti-smart-home"></i></a>
                         </li>
                         <li class="breadcrumb-item">
                            Manager
                         </li>
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                   <div class="me-2 mb-2">
                      <div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                         <a href="${pageContext.request.contextPath}/ManagerDashboardServlet?action=projectDetails" class="btn btn-icon btn-sm active bg-primary text-white me-1"><i class="ti ti-list-tree"></i></a>
                         <a href="${pageContext.request.contextPath}/ManagerDashboardServlet?action=projectDetails" class="btn btn-icon btn-sm"><i class="ti ti-layout-grid"></i></a>
                      </div>
                   </div>
                   <div class="me-2 mb-2">
                       <div class="dropdown">
                           ...
                           <ul class="dropdown-menu dropdown-menu-end p-3">
                               ...
                               <li>
                                   <a href="${pageContext.request.contextPath}/ManagerDashboardServlet?action=exportProjects&sort=${sort}"
                   ...
                   <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                       ...
                       <div class="dropdown">
                           ...
                           <ul class="dropdown-menu dropdown-menu-end p-3">
                               ...
                               <li>
                                   <a href="${pageContext.request.contextPath}/ManagerDashboardServlet?action=projectDetails&sort=asc"
                                      class="dropdown-item rounded-1">
                                       Ascending
                                   </a>
                               </li>
                               ...
                               <li>
                                   <a href="${pageContext.request.contextPath}/ManagerDashboardServlet?action=projectDetails&sort=desc"
                                      class="dropdown-item rounded-1">
                                       Descending
                                   </a>
                               </li>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                         <div class="action-icon d-inline-flex">
                                            ...
                                            <a href="${pageContext.request.contextPath}/ManagerDashboardServlet?action=editProject&projectId=${project.projectId}"
                                               class="me-2"
                                               title="Edit">
                                  ...
                                  <ul class="pagination mb-0">
                                      ...
                                      <c:choose>
                                          ...
                                          <c:when test="${currentPage > 1}">
                                              <li class="page-item">
                                                  <a class="page-link"
                                                     href="${pageContext.request.contextPath}/ManagerDashboardServlet?action=projectDetails&page=${currentPage - 1}">
                                                      Previous
                                                  </a>
                                              </li>
                                          </c:when>
                                      ...
                                      <c:forEach begin="1"
                                          ...
                                          <li class="page-item ${pageNumber == currentPage ? 'active' : ''}">
                                              ...
                                              <a class="page-link"
                                                 href="${pageContext.request.contextPath}/ManagerDashboardServlet?action=projectDetails&page=${pageNumber}">
                                                  ${pageNumber}
                                              </a>
          ...
          <div class="modal-body">
             <div class="text-center p-3">
                ...
                <div>
                   <div class="row g-2">
                      <div class="col-6">
                         <a href="${pageContext.request.contextPath}/ManagerDashboardServlet?action=projectDetails" class="btn btn-dark w-100">Back to List</a>
                      </div>
                      <div class="col-6">
       ...
       <div class="modal-content">
          <div class="modal-body text-center">
             ...
             <div class="d-flex justify-content-center">
                ...
                <a href="${pageContext.request.contextPath}/ManagerDashboardServlet?action=projectDetails" class="btn btn-danger">Yes, Delete</a>
             </div>
          </div>
       </div>
    </div>
