...
<head>
    ...
    <meta name="description" content="HRMS Login">
    <meta name="keywords" content="HRMS, Login, Employee Management">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="login-background position-relative d-lg-flex align-items-center justify-content-center d-none flex-wrap vh-100">
                        ...
                        <div class="bg-overlay-img">
                            ...
                            <img src="${pageContext.request.contextPath}/assets/img/bg/bg-01.png"
                                 class="bg-1"
                                 alt="Img">

                            <img src="${pageContext.request.contextPath}/assets/img/bg/bg-02.png"
                                 class="bg-2"
                                 alt="Img">

                            <img src="${pageContext.request.contextPath}/assets/img/bg/bg-03.png"
                                 class="bg-3"
                                 alt="Img">
                        ...
                        <div class="authentication-card w-100">
                            ...
                            <div class="authen-overlay-item border w-100">
                                ...
                                <div class="my-4 mx-auto authen-overlay-img">
                                    ...
                                    <img src="${pageContext.request.contextPath}/assets/img/bg/authentication-bg-01.png"
                                         alt="Img">
