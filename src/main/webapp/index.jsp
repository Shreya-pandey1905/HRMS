...
<main class="auth-page">
    <div class="auth-shell">
        <section class="glass-hero auth-branding">
            ...
            <h1 class="auth-title" style="margin-top:18px;">Human Resource Management System</h1>
            <p class="auth-subtitle">
                Sign in to manage leave requests, employee records, documents, and profiles — all in one place.
            </p>
            <div class="glass-chip-row" style="margin-top:22px;">
                <span class="glass-chip"><i class="bi bi-lightning-charge"></i> Leave management</span>
                <span class="glass-chip"><i class="bi bi-folder2-open"></i> Document storage</span>
                <span class="glass-chip"><i class="bi bi-people"></i> Employee directory</span>
            </div>
        </section>
        ...
        <section class="glass-auth-card">
          ...
          <p>  <a href="Employeejsp/forgotPassword.jsp">Forgot Password?</a></p>
