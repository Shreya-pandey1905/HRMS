...
<main class="glass-page">
    <section class="glass-hero">
        <div class="glass-hero-grid">
            <div>
                ...
                <h1 class="glass-title">Apply and track <span>your leave</span></h1>
                <p class="glass-subtitle">Submit leave requests for Casual, Sick, Paid, or Unpaid time off and track each request through pending, approved, or rejected status.</p>
    ...
    <section id="leave-table" class="glass-section">
        <div class="glass-toolbar">
            <div>
                <div class="glass-kicker"><i class="bi bi-list-check"></i> My requests</div>
                <h2 style="margin:12px 0 0; font-size:1.65rem; letter-spacing:-0.03em;">Leave history</h2>
            </div>
