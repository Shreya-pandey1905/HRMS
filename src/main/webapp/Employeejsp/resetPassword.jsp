...
<main class="auth-page">
    <div class="auth-shell" style="grid-template-columns:0.95fr 1.05fr;">
        <section class="glass-hero auth-branding">
            ...
            <p class="auth-subtitle">Change your password to keep your account secure. You will need your current password to confirm the update.</p>
        ...
        <section class="glass-auth-card">
            ...
            <% } %>
           <form action="/HRMS/resetPasswords" method="post">
