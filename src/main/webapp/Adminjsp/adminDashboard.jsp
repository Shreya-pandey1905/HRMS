...
<main class="glass-page">
    ...
    <section class="glass-hero">
        <div class="glass-hero-grid">
            <div>
                <div class="glass-kicker"><i class="bi bi-speedometer2"></i> Admin dashboard</div>
                <h1 class="glass-title">Welcome back, <span><%= name %></span></h1>
                <p class="glass-subtitle">Monitor leave activity at a glance, manage employee accounts, and access documents — your central overview for HR operations.</p>
