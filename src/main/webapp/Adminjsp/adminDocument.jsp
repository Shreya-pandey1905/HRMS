...
<nav class="glass-navbar">
    ...
    <div class="glass-navbar-inner">
        ...
        <div class="glass-nav-links">
            ...
            <a class="glass-nav-link" href="adminDashboard">
            ...
            <a class="glass-nav-link" href="employee">
        ...
        <div class="glass-hero-grid">
            ...
            <div>
                ...
                <h1 class="glass-title">
                    Document center
                    <span>for the HR team</span>
                </h1>

                <p class="glass-subtitle">
                    Upload, browse, and download employee documents.
                    Manage HR files and supporting records for your team.
                </p>
