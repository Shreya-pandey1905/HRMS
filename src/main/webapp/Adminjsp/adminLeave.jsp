    ...
    <main class="glass-page">
        <section class="glass-hero">
            <div class="glass-hero-grid">
                <div>
                    ...
                    <h1 class="glass-title">Review and manage <span>leave requests</span></h1>
                    <p class="glass-subtitle">View all employee leave submissions, approve or reject pending requests, and monitor total, pending, approved, and rejected counts.</p>
            ...
            <div class="glass-form-card">
                ...
                <form action="ApplyLeave" method="post">
                    <div class="glass-form-grid">
                        ...
                        <div class="glass-field glass-date-field" style="grid-column: span 3;">
                            <label>Start Date</label>
                            <div class="glass-date-wrap">
                               <input type="date" id="date" name="startDate" class="glass-control" min="<%= java.time.LocalDate.now() %>" required>
                                <i class="bi bi-calendar3 glass-date-icon"></i>
                            </div>
                        </div>
                        <div class="glass-field glass-date-field" style="grid-column: span 3;">
        ...
        <section id="leave-table" class="glass-section">
            <div class="glass-toolbar">
                <div>
                    <div class="glass-kicker"><i class="bi bi-list-check"></i> Leave queue</div>
                    <h2 style="margin:12px 0 0; font-size:1.65rem; letter-spacing:-0.03em;">All leave requests</h2>
                </div>
                <label class="glass-search" for="leaveSearch">
                    <i class="bi bi-search"></i>
                    <input type="search"
                           id="leaveSearch"
                           placeholder="Search by name, type, reason, or status..."
                           data-table-search="#leaveTable"
                           autocomplete="off">
                </label>
            </div>
            <div class="glass-table-wrap">
                <table class="glass-table" id="leaveTable">
                    <thead>
                        <tr>
                            <th>Employee Name</th>
                            <th>Leave Type</th>
                         ...
                         <td>
                             <% if (!"APPROVED".equalsIgnoreCase(leave.getStatus()) && !"REJECTED".equalsIgnoreCase(leave.getStatus())) { %>
                                 ...
                                 <div class="glass-actions" style="margin-top:0;">
                                     <a href="ApproveLeave?id=<%= leave.getId() %>" class="glass-btn glass-btn-success">
                                         <i class="bi bi-check2"></i> Approve
                                     </a>

                                     <a href="RejectLeave?id=<%= leave.getId() %>" class="glass-btn glass-btn-danger">
